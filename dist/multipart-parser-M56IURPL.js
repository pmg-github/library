...
var require_multipart_parser = __commonJS({
  "node_modules/node-fetch-native/dist/chunks/multipart-parser.cjs"(exports) {
    ...
    __require("fs"), __require("path");
    var node = require_node();
    __require("http"), __require("https"), __require("zlib"), __require("stream"), __require("buffer"), __require("util"), require_node_fetch_native_DhEqb06g(), __require("url"), __require("net");
    var s = 0;
