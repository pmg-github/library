...
function T() {
  ...
  U = 1;
  const C2 = Y();
  return _ = { isSpaceSeparator(r) {
    return typeof r == "string" && C2.Space_Separator.test(r);
  }, isIdStartChar(r) {
    return typeof r == "string" && (r >= "a" && r <= "z" || r >= "A" && r <= "Z" || r === "$" || r === "_" || C2.ID_Start.test(r));
  }, isIdContinueChar(r) {
    return typeof r == "string" && (r >= "a" && r <= "z" || r >= "A" && r <= "Z" || r >= "0" && r <= "9" || r === "$" || r === "_" || r === "\u200C" || r === "\u200D" || C2.ID_Continue.test(r));
  }, isDigit(r) {
...
function uu() {
  ...
  function v(D, a, g) {
    ...
    if (y != null && typeof y == "object") if (Array.isArray(y)) for (let P = 0; P < y.length; P++) {
      ...
      H === void 0 ? delete y[I] : Object.defineProperty(y, I, { value: H, writable: true, enumerable: true, configurable: true });
    }
    else for (const P in y) {
      const I = v(y, P, g);
      I === void 0 ? delete y[P] : Object.defineProperty(y, P, { value: I, writable: true, enumerable: true, configurable: true });
    }
    return g.call(D, a, y);
  }
  let t, e, x, w, A;
  function E() {
    for (t = "default", e = "", x = false, w = 1; ; ) {
      A = n();
      const D = l[t]();
      if (D) return D;
    }
...
`:
    ...
    switch (A) {
      case "{":
      case "[":
        return F("punctuator", u());
      case "n":
        return u(), i("ull"), F("null", null);
      case "t":
        return u(), i("rue"), F("boolean", true);
      case "f":
        return u(), i("alse"), F("boolean", false);
      case "-":
      case "+":
        u() === "-" && (w = -1), t = "sign";
        return;
      ...
      case "9":
        ...
        return;
      case "I":
        return u(), i("nfinity"), F("numeric", 1 / 0);
      case "N":
        return u(), i("aN"), F("numeric", NaN);
      case '"':
      case "'":
        x = u() === '"', e = "", t = "string";
        return;
    ...
    switch (D) {
      ...
      case "\u200D":
        break;
      default:
        if (!C2.isIdContinueChar(D)) throw L();
        break;
    }
    e += D, t = "identifierName";
  }, sign() {
    switch (A) {
      ...
      case "9":
        ...
        return;
      case "I":
        return u(), i("nfinity"), F("numeric", w * (1 / 0));
      case "N":
        return u(), i("aN"), F("numeric", NaN);
    }
    throw B(u());
...
`:
  ...
  function F(D, a) {
    return { type: D, value: a, line: h, column: o };
  }
  function i(D) {
    for (const a of D) {
      if (n() !== a) throw B(u());
...
` && u(), "";
  ...
  function b() {
    let D = "", a = n();
    if (!C2.isHexDigit(a) || (D += u(), a = n(), !C2.isHexDigit(a))) throw B(u());
  ...
  function $() {
    ...
    for (; a-- > 0; ) {
      const g = n();
      if (!C2.isHexDigit(g)) throw B(u());
      D += u();
    }
    return String.fromCodePoint(parseInt(D, 16));
  }
  const Q = { start() {
    if (f.type === "eof") throw N2();
    V();
  }, beforePropertyName() {
    switch (f.type) {
      case "identifier":
  ...
  function V() {
    ...
    if (m === void 0) m = D;
      ...
      Array.isArray(a) ? a.push(D) : Object.defineProperty(a, S, { value: D, writable: true, enumerable: true, configurable: true });
    }
...
` + n + "}";
    ...
    function w(E) {
      ...
      if (!C2.isIdStartChar(n)) return e(E);
      for (let u = n.length; u < E.length; u++) if (!C2.isIdContinueChar(String.fromCodePoint(E.codePointAt(u)))) return e(E);
      return E;
    }
    function A(E) {
      if (h.indexOf(E) >= 0) throw TypeError("Converting circular structure to JSON5");
...
var ru = R(Fu);
function Cu(C2, r) {
  const s = eu(C2, r?.reviver);
  return N(C2, s, r), s;
}
function Au(C2, r) {
  const s = C(C2, r), c = ru(C2, r?.replacer, s.indent);
  return s.whitespace.start + c + s.whitespace.end;
}
