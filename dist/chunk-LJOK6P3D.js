...
var en = Ve;
var nn = $e;
var y = { isNothing: Xe, isObject: Ze, toArray: ze, repeat: Je, isNegativeZero: en, extend: nn };
function ue(e, n) {
...
var ln = rn;
var on = ["kind", "multi", "resolve", "construct", "instanceOf", "predicate", "represent", "representName", "defaultStyle", "styleAliases"];
var un = ["scalar", "sequence", "mapping"];
function fn(e) {
  var n = {};
...
var pn = V;
var tn = new C2("tag:yaml.org,2002:str", { kind: "scalar", construct: function(e) {
  return e !== null ? e : "";
} });
var hn = new C2("tag:yaml.org,2002:seq", { kind: "sequence", construct: function(e) {
  return e !== null ? e : [];
} });
var dn = new C2("tag:yaml.org,2002:map", { kind: "mapping", construct: function(e) {
  return e !== null ? e : {};
} });
var sn = new pn({ explicit: [tn, hn, dn] });
function xn(e) {
...
var An = new C2("tag:yaml.org,2002:null", { kind: "scalar", resolve: xn, construct: mn, predicate: gn, represent: { canonical: function() {
  return "~";
}, lowercase: function() {
  return "null";
}, uppercase: function() {
...
var _n = new C2("tag:yaml.org,2002:bool", { kind: "scalar", resolve: vn, construct: yn, predicate: Cn, represent: { lowercase: function(e) {
  return e ? "true" : "false";
...
var On = new C2("tag:yaml.org,2002:int", { kind: "scalar", resolve: Sn, construct: En, predicate: Tn, represent: { binary: function(e) {
...
var In = new RegExp("^(?:[-+]?(?:[0-9][0-9_]*)(?:\\.[0-9_]*)?(?:[eE][-+]?[0-9]+)?|\\.[0-9_]+(?:[eE][-+]?[0-9]+)?|[-+]?\\.(?:inf|Inf|INF)|\\.(?:nan|NaN|NAN))$");
function kn(e) {
...
var Mn = new C2("tag:yaml.org,2002:float", { kind: "scalar", resolve: kn, construct: Ln, predicate: Dn, represent: Rn, defaultStyle: "lowercase" });
var Yn = sn.extend({ implicit: [An, _n, On, Mn] });
var Bn = Yn;
...
var Un = new C2("tag:yaml.org,2002:timestamp", { kind: "scalar", resolve: Pn, construct: jn, instanceOf: Date, represent: Hn });
function Kn(e) {
  return e === "<<" || e === null;
}
var qn = new C2("tag:yaml.org,2002:merge", { kind: "scalar", resolve: Kn });
...
var Vn = new C2("tag:yaml.org,2002:binary", { kind: "scalar", resolve: Gn, construct: Wn, predicate: Qn, represent: $n });
...
var ei = new C2("tag:yaml.org,2002:omap", { kind: "sequence", resolve: zn, construct: Jn });
...
var li = new C2("tag:yaml.org,2002:pairs", { kind: "sequence", resolve: ii, construct: ri });
...
var ci = new C2("tag:yaml.org,2002:set", { kind: "mapping", resolve: ui, construct: fi });
var pe = Bn.extend({ implicit: [Un, qn], explicit: [Vn, ei, li, ci] });
...
var ai = 2;
var de = 3;
var pi = /[\x00-\x08\x0B\x0C\x0E-\x1F\x7F-\x84\x86-\x9F\uFFFE\uFFFF]|[\uD800-\uDBFF](?![\uDC00-\uDFFF])|(?:[^\uD800-\uDBFF]|^)[\uDC00-\uDFFF]/;
var ti = /[\x85\u2028\u2029]/;
var hi = /[,\[\]\{\}]/;
var se = /^(?:!|!!|![a-z\-]+!)$/i;
...
function wi(e, n, i) {
  ...
  for (e.anchor !== null && (e.anchorMap[e.anchor] = p), m = e.input.charCodeAt(e.position); m !== 0; ) {
    if (!A && e.firstTabInLine !== -1 && (e.position = e.firstTabInLine, h(e, "tab characters must not be used in indentation")), l = e.input.charCodeAt(e.position + 1), u = e.line, (m === 63 || m === 58) && F(l)) m === 63 ? (A && (N2(e, p, d, s, x, null, o, f, c), s = x = g = null), b = true, A = true, r = true) : A ? (A = false, r = true) : h(e, "incomplete explicit mapping pair; a key node is missed; or followed by a non-tabulated empty line"), e.position += 1, m = l;
      ...
      if (e.line === u) {
        ...
        if (m === 58) m = e.input.charCodeAt(++e.position), F(m) || h(e, "a whitespace character is expected after the key-value separator within a block mapping"), A && (N2(e, p, d, s, x, null, o, f, c), s = x = g = null), b = true, A = false, r = false, s = e.tag, x = e.result;
  ...
  return A && N2(e, p, d, s, x, null, o, f, c), b && (e.tag = a, e.anchor = t, e.kind = "mapping", e.result = p), b;
}
function Fi(e) {
...
var Qi = ["y", "Y", "yes", "Yes", "YES", "on", "On", "ON", "n", "N", "no", "No", "NO", "off", "Off", "OFF"];
var Vi = /^[-+]?[0-9_]+(?::[0-9_]+)+(?:\.[0-9_]*)?$/;
function Xi(e, n) {
  var i, l, r, u, o, f, c;
  if (n === null) return {};
...
var B = 2;
function Ji(e) {
  this.schema = e.schema || pe, this.indent = Math.max(1, e.indent || 2), this.noArrayIndent = e.noArrayIndent || false, this.skipInvalid = e.skipInvalid || false, this.flowLevel = y.isNothing(e.flowLevel) ? -1 : e.flowLevel, this.styleMap = Xi(this.schema, e.styles || null), this.sortKeys = e.sortKeys || false, this.lineWidth = e.lineWidth || 80, this.noRefs = e.noRefs || false, this.noCompatMode = e.noCompatMode || false, this.condenseFlow = e.condenseFlow || false, this.quotingType = e.quotingType === '"' ? B : zi, this.forceQuotes = e.forceQuotes || false, this.replacer = typeof e.replacer == "function" ? e.replacer : null, this.implicitTypes = this.schema.compiledImplicit, this.explicitTypes = this.schema.compiledExplicit, this.tag = null, this.result = "", this.duplicates = [], this.usedDuplicates = null;
}
function ke(e, n) {
...
function rr(e, n, i, l, r, u, o, f) {
  var c, a = 0, t = null, p = false, d = false, s = l !== -1, x = -1, g = nr(j(e, 0)) && ir(j(e, e.length - 1));
  ...
  e.dump = function() {
    ...
    switch (rr(n, f, e.indent, o, c, e.quotingType, e.forceQuotes && !l, r)) {
      ...
      case re:
        return "'" + n.replace(/'/g, "''") + "'";
      case Me:
        return "|" + Be(n, e.indent) + Pe(ke(n, u));
      case Ye:
        return ">" + Be(n, e.indent) + Pe(ke(or(n, o), u));
      case D:
        return '"' + ur(n) + '"';
      default:
...
function E(e, n, i, l, r, u, o) {
  e.tag = null, e.dump = i, Ue(e, i, false) || Ue(e, i, true);
  ...
  if (t && (p = e.duplicates.indexOf(i), d = p !== -1), (e.tag !== null && e.tag !== "?" || d || e.indent !== 2 && n > 0) && (r = false), d && e.usedDuplicates[p]) e.dump = "*ref_" + p;
    ...
    if (t && d && !e.usedDuplicates[p] && (e.usedDuplicates[p] = true), f === "[object Object]") l && Object.keys(e.dump).length !== 0 ? (ar(e, n, e.dump, r), d && (e.dump = "&ref_" + p + e.dump)) : (cr(e, n, e.dump), d && (e.dump = "&ref_" + p + " " + e.dump));
...
function gr(e, n) {
  const i = C(e, {}), l = typeof i.indent == "string" ? i.indent.length : i.indent, r = xr(e, { indent: l, ...n });
