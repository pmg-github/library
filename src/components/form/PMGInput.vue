...
<template>
  <div class="relative">
    ...
    <input
      ...
      :class="[
        attrs.placeholder ? '' : 'placeholder-shown:border',
        meta.valid === false && meta.touched
          ? attrs.placeholder
            ? 'border-red-500 border-t-transparent text-red-500 focus:border-red-500 focus:border-t-transparent'
          ...
          : attrs.placeholder
          ? 'border-gray-700 border-t-transparent text-gray-700 focus:border-gray-700 focus:border-t-transparent'
    ...
    <label
      ...
      :class="[
        ...
        meta.valid === false && meta.touched
          ? attrs.placeholder
            ? 'text-red-500 before:border-red-500 after:border-red-500 peer-focus:text-red-500 peer-focus:before:border-t-2 peer-focus:before:!border-red-500 peer-focus:after:border-t-2 peer-focus:after:!border-red-500'
          ...
          : attrs.placeholder
          ? 'text-gray-700 before:border-gray-700 after:border-gray-700 peer-focus:text-gray-700 peer-focus:before:border-t-2 peer-focus:before:!border-gray-700 peer-focus:after:border-t-2 peer-focus:after:!border-gray-700'
